                            ...
                            <tbody id="load-transaksi">
                                @foreach ($data['transactions'] as $trx)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-pill badge-{{ $bgBanner }} badge-lg">{{ __($trx->status_transaksi) }}</span>
                                        </td>
                                        @if ($status != 'menunggu pembayaran')
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($status == 'dibayar')
                                                            <form id="form-success-trx"
                                                                action="{{ route('transaction.success', ['trxID' => base64_encode($trx->detail_transaksi)]) }}"
                                                                method="post">
